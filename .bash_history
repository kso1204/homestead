...
git clone ~/code$ https://github.com/rappasoft/laravel-boilerplate.git
...
cd _logs
ls
vi 2020-07-15T08_52_02_099Z-debug.log 
ls
cd ..
ls
cd code
...
npm install
cd ..
cd vagrant/.npm/_logs/
vi 2020-07-15T09_43_36_130Z-debug.log
...
php artisan migrate
php artisan migrate:rollback
php artisan make:migration create_article_tags_table --create=article_tags
php artisan migrate
php artisan migrate:rollback
php artisan migrate
php artisan migrate:rollback
...
cd ..
git add .
git commim -m '엘로퀀트orm'
git commit -m '엘로퀀트orm'
git push
cd code
cd project1
...
php artisan db:seed
Php artsian mirgate:refresh --seed
php artsian mirgate:refresh --seed
php artisan mirgate:refresh --seed
...
cd code
ls
git clone https://github.com/kso1204/homestead.git
cd code
ls
git --version
laravel -v
...
cd ..
ls
git clone fatal: could not create work tree dir 'homestead': Permission denied
git clone https://github.com/kso1204/homestead.git
sudo chmod 777 home
ls
cd ..
...
ls
git clone https://github.com/kso1204/homestead.git
rename vagrant vagrant2
mv vagrant vagrant2
mv homestead vagrant
ls
cd vagrant
ls
cd code
